<!-- Olá, estou muito feliz de estar aqui, só não entendo o porque mas enfim fique a vontade -->
<template>
  <div>
        ...
        >
          <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white">
            ...
            <div class="flex-shrink-0 flex items-center px-4">
              <img class="h-8 w-auto" src="../../assets/images/paz.jpg" alt="Workflow" />
            </div>
    ...
    <div class="md:pl-64 flex flex-col flex-1">
      ...
      <main class="flex-1">
        <div class="py-6">
          <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 text-left">
            <router-view />
          </div>
        </div>
      </main>
...
import { BellIcon, HomeIcon, MenuAlt2Icon, UsersIcon, BookmarkAltIcon, XIcon } from '@heroicons/vue/outline';
